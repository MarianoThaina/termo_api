...
class GameController extends Controller
{
    ...
    private function getWords(): array
    {
        ...
        return array_map(fn($word) => mb_strtolower(trim($word), 'UTF-8'), file($path, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES));
    }
    ...
    public function validateGuess(Request $request)
    {
        ...
        $guess = mb_strtolower(trim($request->palavra), 'UTF-8');
        ...
        $secret = mb_strtolower(trim($game->secret_word), 'UTF-8');
